...
## [[to do]] -- Plan to move to package:
## * move code to separate directory (done)
## * Move functions to separate file (done)
## * make R project (r package)
## * add git repo
...
## [[to do]]
## * document and comment functions below!
## * make bodyfat overall column
## * flag bodyfat
## * plot bodyfat
## * extract common parts of plots (events, time axes, etc.)

## [[to do]]
## * function to get individual measurements from caliper measurements
## * check for [[?]]
